...
declare module "qvangular" {
    export const qvang: IQVAngular;
    export default qvang;
}
...
declare namespace BackendAPI {
    ...
    interface IFieldAttributes {
        ...
        /**
         * Defines the thousand separator.
    ...
    interface IBackend {
         ...
         */
        getData(qPages: INxPage[]): ng.IPromise<QDataPage[]>;
...
declare namespace AppAPI {
    interface IApp {
         ...
         */
        createCube(qHyperCubeDef: QHyperCubeDef, callback?: (result, app: IApp) => void): ng.IPromise<any>;
         ...
         * @return - A promise of an object model.
         */
        createGenericObject(def?: { expression: { qStringExpression?: string, qHyperCubeDef?: QHyperCubeDef } } | any, callback?: any): ng.IPromise<any>;
         ...
         * @return - A promise of an object model.
         */
        createList(qListObjectDef: any, callback?: (result, app: IApp) => void): ng.IPromise<any>;
         ...
         * @return - A promise of a Qlik engine reply.
         */
        destroySessionObject(qId: string): ng.IPromise<any>;
         ...
         * @return - A promise of an object model.
         */
        getList(type: string, callback?: (result: GetListResponse) => void): ng.IPromise<GetListResponse>;
        ...
        layout: {
            ...
            qLocaleInfo: any;
            qMeta: { hassectionaccess: boolean }
            qStateNames: string[];
            qThumbnail: any;
            /**
             * APP Title
         ...
         * @return - A promise of a Qlik engine reply.
         */
        searchAssociations(qTerms: string[], qPage: { qOffset: number; qCount: number; qMaxNbrFieldMatches: number; }, qOptions?: { qSearchFields?: any[]; qContext: string; }, callback?: (
            reply: {
                qResults: {
        ...
        variable: VariableAPI.IVariable;

        visualization: VisualizationAPI.IVisualization;
    }
}
...
declare namespace FieldAPI {
    interface IQField {
         ...
         * @return - A promise.
         */
        selectValues(array: IQFieldValue[] | string[] | number[], toggle?: boolean, softlock?: boolean): ng.IPromise<any>;
...
declare namespace VisualizationAPI {
    ...
    interface IVisualization {
         ...
         */
        create(type: VisualizationType, cols?: (any)[], options?: any): ng.IPromise<IQVisualization>;
         ...
         * @return - A promise of a QVisualization.
         */
        get(id: string): ng.IPromise<IQVisualization>;
    }
    ...
    interface IQVisualization {
         ...
         * @return - A promise.
         */
        exportData(options?: any): ng.IPromise<any>;

        /**
         * Closes a visualization and releases the session object.
         * @return - A promise.
         */
        exportImg(options?: any): ng.IPromise<any>;

        /**
         * Closes a visualization and releases the session object.
         * @return - A promise.
         */
        exportPdf(options?: any): ng.IPromise<any>;
         ...
         */
        show(element?: HTMLElement | string, options?: any): void;
    }
}
...
declare namespace ExtensionAPI {
    ...
    interface IData<Properties> {
        dimensions: {
            uses: "dimensions",
            min: number,
            max: number,
            add: (def: QDimensionDef, properties: Properties, handler: DataHandler) => void,
            remove: (def: QDimensionDef, properties: Properties, handler: DataHandler, dimensionNumber: number) => void,
            replace: (newDimension: QDimensionDef, oldDimension: QDimensionDef, existingDimensionNumber: number, properties: Properties) => void
        },
        measures: {
            uses: "measures",
            min: number,
            max: number,
            add: (def: QMeasureDef, properties: Properties, handler: DataHandler) => void,
            remove: (def: QMeasureDef, properties: Properties, handler: DataHandler, measureNumber: number) => void,
            replace: (newMeasure: QMeasureDef, oldMeasure: QMeasureDef, existingMeasureNumber: number, properties: Properties) => void
        }
    }

    /*
     * Basic Qlik Extension 
     * Propeties: RootProperties of Extension
     */
    interface IExtension<Properties> {
        data?: IData<Properties>;
        definition: any;
        importProperties?: (importData: ImportData, properties: Properties) => void;
        getContextMenu?: (a: any, b: any, c: any) => void;
...
//#region default (angular, etc)
declare module '*.html';
declare module '*.png';
declare module 'qr';
declare module 'jquery';
declare let $;
declare interface AngularSce {
    trustAsHtml: (text: string) => string;
}
declare interface Scope extends ng.IScope {
    selectValues(dimNum: number, elemNums: number[], toggle: boolean);
    $parent: Scope;
    backendApi: BackendAPI.IBackend;
    qlik: RootAPI.IRoot;
...
//#region Qlik standard
declare interface Layout_Qlik {
...
declare interface QHyperCubeDef {
    qDimensions: QDimensionDef[];
    qMeasures: QMeasureDef[];
    qInterColumnSortOrder: number[];
}
declare interface QColumnDef {
...
declare interface QDimensionDef extends QColumnDef {
    qDef: {
        autoSort: boolean;
        cId: string;
        qReverseSort: boolean;
    ...
    qOtherLabel: { qv: string; };
    qOtherTotalSpec: {
        qOtherCounted: { qv: string; };
        qOtherLimit: { qv: string; };
...
declare interface QMeasureDef extends QColumnDef {
    qDef: {
        autoSort: boolean;
        cId: string;
        qReverseSort: boolean;
...
declare interface DataHandler {
    addDimension(def: QDimensionDef);
    addMeasure(def: QMeasureDef);
    removeDimension(dimensionNum: number);
    removeMeasure(measureNum: number);
}
declare interface QGrandTotalRow {
    qElemNumber: number;
    qIsTotalCell: boolean;
    qNum: number;
    qState: string;
...
declare interface GetListResponse {
    layout: {
        qVariableList: {
            qItems: {
                qName: string
        ...
        qAppObjectList: {
            qItems: {
                qData: { title: string; cells: { name: string, type: string; }[] };
                qInfo: { qId: string; };
            }[]
        };
    },
...
declare interface VariableGetContentResponse {
    qContent: {
        qIsNum: boolean;
        qString: string;
    }
}
declare interface ListObjectData extends ObjectData {
    qDimensionInfo: QDimensionDef;
}
declare interface qObject {
    layout: { qListObject: ListObjectData };
    id: string;
    acceptListObjectSearch(qListObjectDef: string);
    acceptListObjectSearch(qListObjectDef: string, toggle: boolean);
    beginSelections(qListObjectDef: string[]);
    endSelections(qListObjectDef: boolean);
    abortListObjectSearch(qListObjectDef: string);
    clearSelections(qListObjectDef: string, dimensions: number[]);
    searchListObjectFor(qListObjectDef: string, searchText: string);
    selectListObjectValues(qListObjectDef: string, ids: number[], toggle: boolean);
    selectListObjectAll(qListObjectDef: string);
    selectListObjectAlternative(qListObjectDef: string);
    selectListObjectExcluded(qListObjectDef: string);
    selectListObjectPossible(qListObjectDef: string);
    selectHyperCubeCells(qHyperCubeDef: string, elemNums: number[], dimNum: number[]);
}
declare interface ImportData {
    data: {
        dimensions: QDimensionDef[];
        measures: QMeasureDef[];
        qInterColumnSortOrder: number[];
    }[];
    properties: any;
}
declare interface QHyperCube extends ObjectData {
    qDimensionInfo: QColumnInfo[];
    qMeasureInfo: QColumnInfo[];
    qEffectiveInterColumnSortOrder: number[];
    qGrandTotalRow: QGrandTotalRow[];
}
declare interface QColumnInfo {
    qFallbackTitle: string;
    cId: string;
    qStateCounts: {
        qAlternative: number;
...
declare interface QMC_CustomProperty {
    id?: string;
    createdDate?: string;
    modifiedDate?: string;
...
declare interface QMC_DataConnection {
    id?: string;
    name: string;
...
declare interface QMC_User {
    id: string;
    createdDate: string;
    modifiedDate: string;
    modifiedByUserName: string;
    customProperties: QMC_CustomProperty[];
    userId: string;
...
declare interface QMC_Count {
    value: number;
}
declare interface QMC_Task {
    createdDate?: string;
    enabled?: boolean;
    id: string;
...
declare interface QMC_Extension {
    id: string;
    name: string;
}
declare interface QMC_ExtensionSchema {
    name: string;
    description: string;
    icon: string;
    type: string;
...
declare interface QMC_DefinitionOptions {
    value: string;
    label: string;
}
//#endregion
...
declare interface SaaS_Extension {
    id: string;
    name: string;
    description: string;
    qextVersion: string;
